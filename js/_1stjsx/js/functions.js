...
array_lengths.push( findLongestWord( ["Zimbab", "Sudan", "Madaga"] ) );
array_lengths.push( findLongestWord( ["Kazaks", "Russia", "Bulgar"] ) );
array_lengths.push( findLongestWord( ["Mexico", "Guatem", "Chile"] ) );
